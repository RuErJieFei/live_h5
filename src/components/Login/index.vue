<template>
  <div class="main">
    <div class="login">
      ...
      <input type="password" name="p" placeholder="密码" required="required" v-model="password"/>
...
const username = ref("18951081586")
const password = ref("123123")

const login = async () => {
  const res = await axios.post(loginUrl + "/login/phone",
      {
